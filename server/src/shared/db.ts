...
import { UserRepository } from '../modules/profile/repositories/profile.repository';
...
import { InterviewRepository } from '../modules/interview/repositories/interview-legacy.repository';

// Re-export model schemas for compatibility and modular imports
export { UserProfile } from '../modules/profile/models/profile.model';
export { JobListing, HistoricalJob, GeneratedArtifact } from '../modules/jobs/models/job.model';
export { ChatHistory } from '../modules/chat/models/chat.model';
export { MockInterview } from '../modules/interview/models/interview-legacy.model';
